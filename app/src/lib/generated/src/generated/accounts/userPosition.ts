...
export const USER_POSITION_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  251, 248, 209, 245, 83, 234, 17, 27,
]);

export function getUserPositionDiscriminatorBytes(): ReadonlyUint8Array {
